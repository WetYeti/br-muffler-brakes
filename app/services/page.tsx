...
const servicesList = [
  {
    name: "Core Service",
    description: "Professional auto repair shop services tailored to your needs.",
    icon: Wrench,
    color: "text-blue-600"
  },
  {
    ...
    <div className="pt-16">
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Comprehensive solutions for all your auto repair shop needs
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">Why B&R Muffler & Brakes?</h2>
