    ...
    <div className="pt-16">
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-6">About B&R Muffler & Brakes</h1>
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Dedicated to excellence in auto repair shop since day one
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-slate-600 mb-6">
            B&R Muffler & Brakes was founded on the principle that quality workmanship and honest communication should be standard.
          </p>
          <p className="text-lg text-slate-600 mb-6">
